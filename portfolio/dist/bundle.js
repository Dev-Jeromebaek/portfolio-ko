...
module.exports = {
  profile: {
    ...
    links: [{ name: "portfolio", href: "https://jeromeBaek-portfolio.ml" }, { name: "github", href: "https://github.com/Dev-JeromeBaek" }, { name: "pinterest", href: "https://www.pinterest.co.kr/jeromebaek/" }, { name: "blog", href: "https://blog.naver.com/backsajang420" }]
  },
  introduction: `
  ...
  summary: {
    "경력 요약": [{
      ...
      title: "TMON (주)티몬 - 인턴",
      contents: ["주 - Front End 개발 (React)", "서브 - Back End 개발 (JSP/SPRING)"]
    }, {
  ...
  detailContents: {
    "TMON (티몬) - 인턴": {
      date: "2018.07 - 2018.08",
      info: "국내 최초의 소셜 커머스 회사로서 중견기업, 2017년 매출 4,000억, 종업원수 1000여명, 솔루션 / 서비스 / 배송 / 영상제작 등의 업무 영역을 가지고 있음.",
      service: ['Project<br /> - <a onClick="alert(`업체의 공개 제한요청으로 비공개처리 되었습니다.`)" style="text-decoration:underline;cursor:pointer">01. TMON DashBoard <a/>'],
      project: {
        project: [{
          date: "2018.07 - 2018.08",
          ...
          contents: ["사내 시스템 대시보드 개발", `
              ...
              `, "- 사내 시스템 관리를 위한 관리자페이지 및 대시보드 개발", "- 기여도 : 40%", "- stack : JAVA, JSP, Spring 4.x, React, Babel, Webpack, Chartist, Axios, ReactStrap, React-Grid-Layout, React-Context-API, Git, Bitbucket, Confluence<br />"]
        }]
      }
    },
    "Coreriver (코아리버)": {
      date: "2017.05 - 2018.06",
      info: "코아리버는 IoT, 영상처리, 쇼핑몰 관련 웹/앱 개발의 선도적인 기업입니다. 안드로이드, iOS, 하이브리드 웹/앱 개발 및 디자인까지 토탈 솔루션을 제공.",
      service: ['Web - 회사 소개 사이트<br /> - <a href="http://www.coreriver.com">http://www.coreriver.com</a> <br /><br />', 'Portfolio<br /> - <a href="http://www.coreriver.com/technology.asp#portfolio">http://www.coreriver.com/technology.asp#portfolio</a> <br /><br />', 'Project<br /> - <a href="http://jeromebaek-portfolio-en.ml/portfolio/proj04_obelab.html">03. OBELAB ( 생체신호 관리 프로그램 )<a/><br /> - <a href="http://jeromebaek-portfolio-en.ml/portfolio/proj03_bmap.html">02. 바나나맵 ( 실시간 상점 정보 어플리케이션 )<a/><br /> - <a href="http://jeromebaek-portfolio-en.ml/portfolio/proj02_vpet.html">01. 바닐라펫 ( 반려동물 분양 정보 어플리케이션 )<a/>'],
      project: {
        project: [{
    ...
    "IT Bank (아이티뱅크)": {
      ...
      info: "개발자 준비 교육 아카데미.",
      service: ['Project<br /> - <a href="http://jeromebaek-portfolio-en.ml/portfolio/proj01_dasam.html">01. DASAM ( 소셜커머스 )<a/>'],
      project: {
        project: [{
