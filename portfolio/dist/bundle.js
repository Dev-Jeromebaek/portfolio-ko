...
module.exports = {
  ...
  detailContents: {
    'TMON (티몬) - 인턴': {
      date: '2018.07 - 2018.08',
      info: '사내 시스템 대시보드 개발',
      service: ['Project<br /> - <a onClick="alert(`업데이트중입니다.`)" style="text-decoration:underline;cursor:pointer">01. TMON DashBoard <a/>'],
      project: {
        project: [{
          date: '2018.07 - 2018.08',
          ...
          contents: ['사내 시스템 대시보드 개발', `
              ...
              `, '- 사내 관리를 위한 관리자페이지 및 대시보드 개발', '- 기여도 : 40%', '- stack : JAVA, JSP, Spring 4.x, React, Babel, Webpack, Chartist, Axios, ReactStrap, React-Grid-Layout, React-Context-API, Git, Bitbucket, Confluence<br />']
        }]
      }
    },
    'Coreriver (코아리버)': {
